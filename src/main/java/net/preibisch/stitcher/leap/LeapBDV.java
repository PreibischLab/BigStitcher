...
public class LeapBDV {

    private static BigDataViewer bdv;
    private static SpimData2 spimdata;
    private static AffineTransform3D currentViewerTransform;
    ...
    public synchronized static void scale(float scaleval){
