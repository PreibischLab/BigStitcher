	...
	public static void main( String[] args )
	{
		...
		*/
		...
		final HashMap< ViewId, AffineTransform3D > computeResults = GlobalOptTwoRound.compute(
				...
				cs,
				new MaxErrorLinkRemoval(),
				new MetaDataWeakLinkFactory( spimData.getViewRegistrations().getViewRegistrations(),
						new SimpleBoundingBoxOverlap<>( spimData.getSequenceDescription(), spimData.getViewRegistrations() ) ),
